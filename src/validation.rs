use crate::candles::get_ftx_candles_daterange;
// use crate::candles::{
...
//     validate_ftx_candle, validate_gdax_candle_by_trade_ids, ProductionCandle,
// };
...
impl Inquisidor {
    ...
    //         //     return;
    //         // };
    //         todo!(); // Fix this comment with the is_validated or remove section
    //         // Resample 01d candle
    //         let candle =
    ...
    //                 if !interval_trades.is_empty() {
    //                     let new_candle = ProductionCandle::new_from_trades(
    //                         market.market_id,
    //                         candle_start,
    //                         &interval_trades,
    //                     );
    ...
    //         // from select query and primary key uniqueness
    //         if !interval_trades.is_empty() {
    //             ProductionCandle::new_from_trades(market.market_id, start_ts, &interval_trades)
    //         } else {
    //             original_candle
    //         }
    //     }
    ...
    pub async fn manual_evaluate_ftx_trades(
        &self,
        event: &Event,
        new_trades: &Vec<FtxTrade>,
    ) -> bool {
...
// #[cfg(test)]
// mod tests {
//     use crate::candles::{create_exchange_candle_table, insert_candle, ProductionCandle};
